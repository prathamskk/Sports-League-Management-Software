...
public class ScoreKeeperViewTournamentDetailsController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try{
            ...
            Logger.getLogger(ScoreKeeperViewTournamentDetailsController.class.getName()).log(Level.SEVERE, null , ex);
        }
    }
            ...
            ButtonArrayList.get(i).setOnAction((new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent e) {
                    ...
                    try {
                        ...
                        SceneSwitcher.switchTo(this.getClass(), e, "ScoreKeeperViewMatchStats.fxml","ui/stylesheets/main.css");
